...
export default function AlertsPage() {
  ...
  const fetchLlmExplanation = async (alert: Alert) => {
    try {
      ...
      const requestData = {
        transaction_data: {
          transaction_amount: 0, // Default values since we don't have full transaction data
          account_age_days: 0,
          channel: 0,
          kyc_verified: 0
        },
        ...
        reasons: alert.reason ? [alert.reason] : [],
        category: "Fraud Alert"
      };

      // Use POST request with the alert data
